...
import { HTTP_STATUS_CODES, HttpStatusCode } from "@/constants/httpStatusCodes"
...
export class ApiResponse {
    ...
    static created(res: Response, message = "Created successfully", data: unknown = null, meta?: Meta) {
    ...
    static badRequest(res: Response, message = "Bad request", data: unknown = null, meta: unknown = null) {
        return this.error(res, HTTP_STATUS_CODES.BAD_REQUEST, message, data, meta)
    }

    static unauthorized(res: Response, message = "Unauthorized", data: unknown = null, meta: unknown = null) {
        return this.error(res, HTTP_STATUS_CODES.UNAUTHORIZED, message, data, meta)
    }

    static forbidden(res: Response, message = "Forbidden", data: unknown = null, meta: unknown = null) {
        return this.error(res, HTTP_STATUS_CODES.FORBIDDEN, message, data, meta)
    }

    static notFound(res: Response, message = "Not found", data: unknown = null, meta: unknown = null) {
        return this.error(res, HTTP_STATUS_CODES.NOT_FOUND, message, data, meta)
    }

    static conflict(res: Response, message = "Conflict", data: unknown = null, meta: unknown = null) {
        return this.error(res, HTTP_STATUS_CODES.CONFLICT, message, data, meta)
    }

    static unprocessableEntity(res: Response, message = "Unprocessable entity", data: unknown = null, meta: unknown = null) {
        return this.error(res, HTTP_STATUS_CODES.UNPROCESSABLE_ENTITY, message, data, meta)
    }

    static tooManyRequests(res: Response, message = "Too many requests", data: unknown = null, meta: unknown = null) {
        return this.error(res, HTTP_STATUS_CODES.TOO_MANY_REQUESTS, message, data, meta)
    }

    // Common Server Error Responses
    static internalServerError(res: Response, message = "Internal server error", data: unknown = null, meta: unknown = null) {
